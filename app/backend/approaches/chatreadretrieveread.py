...
class ChatReadRetrieveReadApproach(Approach):
    ...
    def __init__(
        ...
        enrichment_key:str,
      #  azure_ai_translation_domain: str,   #Update Language Detection and Translation to use Azure Cognitive Multi Service API #798
      ...
      #  self.azure_ai_translation_domain=azure_ai_translation_domain  #Update Language Detection and Translation to use Azure Cognitive Multi Service API #798
